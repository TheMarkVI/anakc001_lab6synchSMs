...
tests = [ {'description': 'Initialize',
    ...
    'steps': [ {'inputs': [('PINA', 0x01)] }, { 'time': 900 } ],
    'expected': [('PORTB', 0x01)],
    },
    {'description': 'button press catch LED',
    'steps': [ {'inputs': [('PINA', 0x00)] }, { 'time': 900 } ],
    'expected': [('PORTB', 0x01)],
    },
    {'description': 'button release reset',
    'steps': [ {'inputs': [('PINA', 0x01)] }, { 'time': 900 } ],
    'expected': [('PORTB', 0x01)],
    },
    {'description': 'button press reset',
    'steps': [ {'inputs': [('PINA', 0x00)] }, { 'time': 900 } ],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'button release reset',
